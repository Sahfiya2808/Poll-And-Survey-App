...
const SocialMedia= () => {
  ...
  useEffect(() => {
    const fetchPolls = async () => {
      try {
        const response = await axios.get('http://localhost:8080/api/polls/category/SocialMedia');
  ...
  return (
    <div className="polls-wrapper">
      <div className="education-poll-container">
        <center>
          <h1>SocialMedia Polls</h1>
          <p>We value your opinion on various socialmedia topics. Please take a moment to participate in our poll and share your thoughts.</p>
        </center>
