...
const Government= () => {
  ...
  useEffect(() => {
    const fetchPolls = async () => {
      try {
        const response = await axios.get('http://localhost:8080/api/polls/category/Government');
    ...
    <div className="polls-wrapper" >
      <div className="education-poll-container">
        <center>
          ...
          <p>We value your opinion on various government topics. Please take a moment to participate in our poll and share your thoughts.</p>
        </center>
